...
all: MergesortParallel.class QuicksortParallel.class Driversort.class
...
test_classes: all MergesortParallelTest.class QuicksortParallelTest.class DriversortTest.class TestSuite.class
